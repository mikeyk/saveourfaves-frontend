This is the frontend to supportseattle.org; it pairs with [the backend code, also open source](https://github.com/Horace-msft/supportseattle-server), so please read the README there as well.
